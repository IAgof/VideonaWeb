...
namespace Videona\Backend\SocialBundle\Model;
 ...
 */
abstract class SocialFacebookManager implements SocialFacebookManagerInterface, UserProviderInterface
{
    /**
     ...
     */
    public function createSocialFacebook()
    {
        $class = $this->getClass();
        $socialfacebook = new $class;
