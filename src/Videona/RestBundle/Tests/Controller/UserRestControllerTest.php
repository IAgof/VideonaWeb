...
//            
//            $crawler = $client->request('GET', '/api/search-user?'.$actual[$i], array(), array(), 
//                                    array(
//                                          'PHP_AUTH_USER' => 'admin',
...
//        $client = static::createClient();
//
//        $crawler = $client->request('POST', '/api/signup', array(), array(), 
//                                        array('CONTENT_TYPE' => 'application/json'),
//                                        json_encode(array("username" => "vprueba",
...
//    }
    ...
    public function testLoginSuccess()
    {
        ...
        for ($i = 0; $i < sizeof($actual_user); $i++) {
            ...
            $crawler = $client->request('GET', '/api/login', array(), array(), 
                                    array(
