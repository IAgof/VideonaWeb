...
class CookieManager {
     ...
     * @param string  $cookieName The default name of the remember me cookie
     ...
     */
    public static function cancelCookie(Request $request, $cookieName, $name, $path, $domain) {
        $request->attributes->set($cookieName, new Cookie($name, null, 1, $path, $domain));
    }
